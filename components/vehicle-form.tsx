...
export function VehicleForm() {
  ...
  const submit = (event: FormEvent) => {
    ...
    setBusy(true);
    const id = addVehicle({ brand: form.brand.trim(), model: form.model.trim(), trim: form.trim.trim(), year: Number(form.year) || undefined, fuel: form.fuel, transmission: form.transmission, mileage: Number(form.mileage), purchaseDate: form.purchaseDate, purchasePrice: Number(form.purchasePrice), targetPrice: Number(form.targetPrice) || undefined, registration: form.registration, vin: form.vin, seller: form.seller, sellerPhone: form.sellerPhone, description: form.description, notes: form.notes, photo: form.photo || undefined, status: form.status });
