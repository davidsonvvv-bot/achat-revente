...
export function BottomNav() {
  ...
  return <nav aria-label="Navigation principale" className="fixed inset-x-0 bottom-0 z-20 mx-auto max-w-md border-t border-[#dfe5df] bg-[#fbfcfa]/95 px-5 pb-[max(12px,env(safe-area-inset-bottom))] pt-2 backdrop-blur" style={{ touchAction: "manipulation" }}>
